...
def profile_to_html_defaults(profile: UserProfile) -> dict[str, Any]:
    ...
    return {
        "person1Name": p.people.primary.name,
        ...
        "simulationMethod": p.simulation.method,
        "withdrawalStrategy": p.simulation.withdrawal_strategy,
        "withdrawalRate": p.simulation.withdrawal_rate,
        ...
        "dynamicSpendingFloor": p.simulation.dynamic_spending.floor,
        "dynamicSpendingCeiling": p.simulation.dynamic_spending.ceiling,
        "gkCapitalPreservation": p.simulation.guyton_klinger.capital_preservation,
        "gkProsperity": p.simulation.guyton_klinger.prosperity,
        "gkAdjustment": p.simulation.guyton_klinger.adjustment,
        "gkSunsetYears": p.simulation.guyton_klinger.sunset_years,
